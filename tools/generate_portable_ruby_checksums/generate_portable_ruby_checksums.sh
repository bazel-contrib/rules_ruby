...
PLATFORMS=("x86_64_linux" "arm64_linux" "arm64_darwin" "x86_64_darwin")
...
if [[ ${all_releases} == "true" ]]; then
  ...
  list_url="${RV_RUBY_LIST_API_URL:-https://api.github.com/repos/bazel-contrib/portable-ruby/releases?per_page=100}"
...
api_url="${RV_RUBY_API_URL:-https://api.github.com/repos/bazel-contrib/portable-ruby/releases/tags}/${ruby_version}-${release_suffix}"
