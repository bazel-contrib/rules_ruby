...
<pre>
rb_binary(<a href="#rb_binary-name">name</a>, <a href="#rb_binary-deps">deps</a>, <a href="#rb_binary-env">env</a>, <a href="#rb_binary-main">main</a>, <a href="#rb_binary-srcs">srcs</a>)
</pre>
...
<pre>
rb_gem_push(<a href="#rb_gem_push-name">name</a>, <a href="#rb_gem_push-deps">deps</a>, <a href="#rb_gem_push-env">env</a>, <a href="#rb_gem_push-main">main</a>, <a href="#rb_gem_push-src">src</a>, <a href="#rb_gem_push-srcs">srcs</a>)
</pre>
...
<pre>
rb_test(<a href="#rb_test-name">name</a>, <a href="#rb_test-deps">deps</a>, <a href="#rb_test-env">env</a>, <a href="#rb_test-main">main</a>, <a href="#rb_test-srcs">srcs</a>)
</pre>
